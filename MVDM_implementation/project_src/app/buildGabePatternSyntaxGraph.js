...
tempViewSet.boundingBoxWidth = 800;
tempViewSet.boundingBoxHeight = 600;
...
tempViewSetLink.parentViewSet = firstGabeTransformRule.rootViewSet;
tempViewSetLink.childViewSet = new ViewSet();
tempViewSetLink.childViewSet.syntaxElem = firstGabeTransformRule.rootElem;
tempViewSetLink.xOffset = 0;
tempViewSetLink.yOffset = 0;
tempViewSetLink.scaleFactor = 0.8; //scale view box to fit

//now, hook up the root elem to its newly created view set!
tempViewSet = tempViewSetLink.childViewSet;
