...
viewSetProto.advanceTagsToNextRound = function(){
...
function ViewBox() {
    ...
    this.yOffset = 0;
    this.scaleFactor = 1.0;	//scale applies to self and all descendants
...
ViewBox.prototype.WithParams = function(shape, width, height, xOffset, yOffset, scale) {
    ...
    this.scaleFactor = scale;	//scale applies to self and all descendants
